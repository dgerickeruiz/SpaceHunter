...
-- Movimiento de Satelite o dron es Satelite!!
...
local function lanzarRed()
	local red = display.newImageRect( mainGroup, "img/red.png", 81, 50 )
...
function scene:create( event )
	...
	-- Cargar el bakground
	local background = display.newImageRect( backGroup, "img/background.png", 340, 720 )
	background.x = display.contentCenterX
	background.y = display.contentCenterY

	-- Carga Planeta tierra
	local tierra = display.newImageRect(mainGroup, "img/tierra.png", 250,250)
	...
	-- Cargar satelite
	satelite = display.newImageRect( mainGroup, "img/satelite.png", 81, 50 )
	...
	vel = 5
	incli = 40
	crearDeshechos(display.contentWidth-200, 20, 5.1, "img/basura1.png", incli)
	crearDeshechos(display.contentWidth-100, 40 , 5.5, "img/basura2.png", incli)
	crearDeshechos(display.contentWidth    , 60, 4.5, "img/basura3.png", incli)
